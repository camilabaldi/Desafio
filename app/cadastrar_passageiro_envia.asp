...
<%
	...
	'Insere no BD
	sql =  "insert into passageiros values ( '" & nome & "', '" & data & "', '" & cpf & "', '" & sexo & "'); " 'case SQL Server
	
	Set rsPass = nothing
	
	'Execute
	Set rsPass = Conexao.execute(sql)
	...
	<body class="body">
	<br>
		<form method="post" action="Visualizar_passageiro.asp" class="form-horizontal" style="float:center" style="float:center; margin-left:20%; margin-right:20%; margin-top:10%">
