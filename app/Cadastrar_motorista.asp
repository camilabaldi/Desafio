      ...
      <div class="container">
        ...
        <div class="row justify-content-start">
          <div class="col-md-12 text-center">
            <h2 class="featurette-heading">Cadastrar Motorista</h2>
          </div>
        </div>
		<hr class="featurette-divider">
      </div><!-- /.container -->
	  <div class="container"><!-- container form -->
		<form id="FrmVenda" action="cadastrar_motorista_envia.asp" method="post" class="form-horizontal" >
				...
				<div class="box-body">
						...
						<div class="col-sm-6">
							<div class="form-group">
								<div class="col-sm-12">
									...
									<input type="text" name="data" id="data" value="" placeholder="00-00-0000" class="form-control datepicker" required />
								</div>
							</div>
						</div>
						<div class="col-sm-6">
					...
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group">
								<div class="col-sm-12">
									<label class="">Modelo do Carro</label>
									<input type="text" name="modeloCarro" id="modeloCarro" value="" class="form-control" required />
								</div>
							</div>
						</div>
						<div class="col-sm-3">
				...
				<div class="box-footer text-right">
					<div class="row">
						<div class="col-sm-12">
							<div class="form-group">
								<div class="col-sm-12">
									<a type="button" style="float:left; color:white" href="Visualizar_motorista.asp" class="btn btn-warning">&nbsp; Visualizar motoristas&nbsp; </a>
